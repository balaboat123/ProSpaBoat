...
<div class="table-responsive my-2">
    ...
    <form action="/Room/createRoom" method="post">
        ...
        <div class="form-group">
            ...
            <textarea id="room_description" class="form-control" name="room_description" rows="5" cols="50"></textarea>
        </div>
        <div class="form-group">
            <label for="name">จำนวนที่นั่ง</label>
            <input type="number" class="form-control" name="room_seat" id="room_seat" placeholder="Room Name">
        </div>
        <div class="form-group">
